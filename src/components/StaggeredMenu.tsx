...
export function StaggeredMenu({
  ...
  const prelayerColors = (() => {
    const raw = colors.length ? colors.slice(0, 4) : ['#ffc9ec', '#830012']
    const arr = [...raw]
    if (arr.length >= 3) {
  ...
  return (
    ...
    >
      ...
      >
        <a href="#accueil" className="sm-logo" aria-label="Karla, accueil">
          {logoUrl ? (
            <img
              src={logoUrl}
              alt="Karla"
